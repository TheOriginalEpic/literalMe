...
Template.mainBody.events({
	...
	'click .js-eSave'(event, instance){
		...
		// var imageCheck = [eCoverImage].every(function(v){return !!v});
		// var authorCheck = [eAuthor].every(function(v){return !!v});
		// var descCheck = [eDescription].every(function(v){return !!v});
		// var titleCheck = [eTitle].every(function(v){return !!v});

		//console.log(eBookID);
		//console.log(modalname);

		// if (imageCheck == false){
		// 	eCoverImage = this.img;
